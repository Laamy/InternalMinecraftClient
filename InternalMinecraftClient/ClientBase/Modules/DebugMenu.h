...
public:
	...
	void OnFrameRender(RenderUtils* ctx) override {
		...
		ctx->DrawString(Vector2(0, 16 * 2), _RGB(255, 255, 255), TextHolder("IsEnchanted: " + player->isEnchanted()), ctx->font, 0.6f);
		ctx->DrawString(Vector2(0, 16 * 3), _RGB(255, 255, 255), TextHolder("IsImmobile: " + player->isImmobile()), ctx->font, 0.6f);
	};
};